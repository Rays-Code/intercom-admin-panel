...
const MobileConversationPageBody = () => {
  ...
  return (
    <div className="relative overflow-y-auto w-full max-w-[425px] border-r border-[#eeefec] flex flex-col justify-between items-center bg-white">
      ...
      <div className='fixed left-0 bottom-0 ml-4 z-[9999]'>
        ...
        {/* Input box for the user (fromUser type) */}
        ...
        onKeyDown={(e) => {
          try {
            ...
            // Setting user (userContext) with the new fromUser value.
        ...
        <button onClick={() => {
          ...
          // Setting the input box empty after the user has entered their reply.
          setMessage("");
          } catch(error){
            console.error("Error updating user chat data:", error);
          } 
