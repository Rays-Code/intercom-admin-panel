...
const MobileAppBar = () => {
  ...
  return (
    <div className="flex justify-between gap-2 pb-4 pt-2 px-4 font-inter border-b border-[#eeefec] w-full">
        ...
        <div className="font-bold text-base cursor-pointer mt-2" onClick={() => {
