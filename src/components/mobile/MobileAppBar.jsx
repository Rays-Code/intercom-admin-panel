...
const MobileAppBar = () => {
  ...
  return (
    <div className="flex justify-between gap-2 pb-2 pt-2 px-4 font-inter border-b border-gray-400 w-full">
        ...
        <div className="font-bold text-base cursor-pointer" onClick={() => {
