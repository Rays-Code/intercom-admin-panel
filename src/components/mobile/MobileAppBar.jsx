...
const MobileAppBar = () => {
  ...
  return (
    <div className="flex justify-between gap-2 p-8 font-inter border-b border-gray-400 w-full">
        ...
        <div className="font-bold text-xs cursor-pointer" onClick={() => Navigate("/")}>Your inbox</div>
        <div className="font-bold text-xs cursor-pointer">Luis Easton</div>
        </div>
        <div className="font-bold text-xs cursor-pointer" onClick={() => {
