import MobileConversationListItem from './MobileConversationListItem'
...
const MobileConversationList = () => {
  return (
    <div className='px-5 pt-3 flex flex-col w-[100%] border-r border-[#eeefec] max-h-[700px] overflow-y-auto'>
        ...
        <MobileConversationListItem avatorColor={"Navy"} name={"Booking API Problems"} message={"Bug report"} time={"45m"} userId={4}/>
